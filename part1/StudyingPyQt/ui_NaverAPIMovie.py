...
# Form implementation generated from reading ui file 'c:\Source\miniprojects\part1\StudyingPyQt\NaverAPIMovie.ui'
#
...
class Ui_FrmMain(object):
    def setupUi(self, FrmMain):
        ...
        FrmMain.setMinimumSize(QtCore.QSize(800, 500))
        FrmMain.setMaximumSize(QtCore.QSize(800, 500))
        font = QtGui.QFont()
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(20, 10, 751, 41))
        ...
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(10, 79, 781, 411))
    ...
    def retranslateUi(self, FrmMain):
        ...
        FrmMain.setWindowTitle(_translate("FrmMain", "네이버 API 영화검색 앱"))
        self.groupBox.setTitle(_translate("FrmMain", "영화 검색"))
