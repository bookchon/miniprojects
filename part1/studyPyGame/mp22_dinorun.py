...
START = pygame.image.load(f'{ASSETS}Dino/DinoStart.png') # 첫 시작 아이콘 이미지
DEAD = pygame.image.load(f'{ASSETS}Dino/DinoDead.png') # 죽었을 때 아이콘 이미지
...
def menu(death_count): # 메뉴 함수
    ...
    while run:
        ...
        if death_count == 0: # 최초
            ...
            text = font.render('재시작 하려면 아무 키나 누르세요', True, (83, 83, 83))
